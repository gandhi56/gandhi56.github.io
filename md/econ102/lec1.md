...
* Bank takes savings from people who earn more than their expenditure and lends to those who need to spend more than what they earn
  * act as intermediary between savers and borrowers
  * provide liquidity (accessible cash on hand for ready-use in exchange for goods and services): always have the money for borrowing
...
* **investment** (or **investment spending**) refers to a spending on productive inputs, such as factories, machinery and inventories
* the price of borrowing is known as **interest rate**.
* ![](16.PNG)
* curve properties
  * the amount people are willing to save increases as the interest rate increases
  * the cost of borrowing decreases as the interest rates decrease, making more and more investment opportunities worth the cost.
  * *rate of return* describes the expected profit that the project will generate per dollar invested.
* changes in the supply and demand for loanable funds
  * savings decision reflect the trade-off people face between spending their income on consumption now and saving it for later.
    * factors: expectations of how well the economy will do in the near future
  * investment decisions are based on the trade-off between the potential profits that could be generated by an investment and the cost of borrowing money to finance that investment.
    * factors: those that change the set of investment opportunities in the economy, increasing or decreasing the number of investments that are worth making at any given interest rate.

* loanable funds in a weak economy
  * when the government borrows more, it can crowd out private investment
  * **crowding out** is the reduction in private borrowing that is caused by an increase in government borrowing.
  * government borrowing reduces the supply of loanable funds and can shift the supply curve to the left, forcing up the interest rates.
  * The shift in the supply curve increases the cost of borrowing and so reduces private investment.
  * this kind of crowding out of private investment if always a fear when the government intervenes in the market.
* In reality, different borrowers pay different interest rates.
  * everyone has the pay higher rates than the Canadian government
